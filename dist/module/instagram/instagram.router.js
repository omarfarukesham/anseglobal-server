 ...
 */
instagramRouter.post('/', instagram_controller_1.instagramController.createInstagram);
/**
 * @swagger
 * /api/instagram:
 *   get:
 ...
 *                 $ref: '#/components/schemas/Instagram'
 */
instagramRouter.get('/', instagram_controller_1.instagramController.getAllInstagrams);
/**
 * @swagger
 * /api/instagram/{id}:
 *   get:
 ...
 *         description: Instagram record not found
 */
instagramRouter.delete('/:id', instagram_controller_1.instagramController.deleteInstagram);
